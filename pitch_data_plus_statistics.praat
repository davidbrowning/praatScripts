...
form Analyze pitch maxima from labeled segments in files
	...
	text sound_directory D:\Projects\praat\repraatscriptsdata\sound\
	sentence Sound_file_extension .wav
	comment Directory of TextGrid files
	text textGrid_directory D:\Projects\praat\repraatscriptsdata\grid\
	sentence TextGrid_file_extension .TextGrid
	comment Full path of the resulting text file:
	text resultfile D:\Projects\praat\repraatscriptsdata\output\output.csv
...
titleline$ = "Filename,Segment label,Maximum pitch (Hz),Minimum pitch (Hz),mean,median,stdev,altqb,dur'newline$'"
	...
	if fileReadable (gridfile$)
		...
		for interval to numberOfIntervals
			...
			if label$ <> ""
				...
				altqb = Get quantile... start end 0.0764 Hertz
				baseline = mean - (1.43 * stdev)
				# Save result to text file:
				resultline$ = "'soundname$','label$','pitchmax','pitchmin','mean','median','stdev','altqb','dur''newline$'"
